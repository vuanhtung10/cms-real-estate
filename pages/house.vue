        ...
        },
        {
          ...
          render(data) {
            ...
            if (data) {
              switch (data) {
                case 'REJECT':
                  return `<p style = "background: red; color:white">${status.text}</p>`
                case 'PENDING':
                  return `<p style = "background: yellow; color:red">${status.text}</p>`
                case 'APPROVE':
                  return `<p style = "background: green; color:white">${status.text}</p>`
              }
            }
          }
        },
